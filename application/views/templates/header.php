                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                            <div class="nav-user-info">
                                <h5 class="mb-0 text-white nav-user-name">
                                    <?=$_SESSION['user']?></h5>
                                <span class="status"></span><span class="ml-2"><?=$_SESSION['tipo']?></span>
                            </div>
                            <!--                            <a class="dropdown-item" href="#"><i class="fas fa-user mr-2"></i>Account</a>-->
                            <!--                            <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Setting</a>-->
                            <a class="dropdown-item" href="<?=base_url()?>Welcome/logout"><i class="fas fa-power-off mr-2"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="nav-left-sidebar sidebar-dark">
        <div class="menu-list">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="d-xl-none d-lg-none" href="<?=base_url()?>Main">Dashboard</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=base_url()?>Bus"><i class="fa fa-fw fa-bus"></i>Flotas y minibuces </a>
